        ...
        <Container>
            <Row className="mt-5">
                <div className="list-group">
                    <a href={() => console.log('')} className="list-group-item list-group-item-action">
                        ...
                        <div className="custom-control custom-switch">
                            ...
                            <label className="custom-control-label" htmlFor="customSwitch1">Completed</label>
                        </div>
                    </a>
                    <a href={() => console.log('')} className="list-group-item list-group-item-action">
                        <div className="d-flex w-100 justify-content-between">
                        ...
                        <div className="custom-control custom-switch">
                            ...
                            <label className="custom-control-label" htmlFor="customSwitch2">Completed</label>
                        </div>
                    </a>
                    <a href={() => console.log('')} className="list-group-item list-group-item-action">
                        <div className="d-flex w-100 justify-content-between">
                        ...
                        <div className="custom-control custom-switch">
                            ...
                            <label className="custom-control-label" htmlFor="customSwitch3">Completed</label>
                        </div>
                    </a>
                </div>
            </Row>
